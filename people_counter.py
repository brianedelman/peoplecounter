...
ap.add_argument("-or", "--orientation", type=str, default='horizontal',
    help="Change line to vertical")
...
if not args.get('prototxt', False):
    args['prototxt'] = 'mobilenet_ssd/MobileNetSSD_deploy.prototxt'

if not args.get('model', False):
    ...
    for (objectID, centroid) in objects.items():
        ...
        # to determine direction
            ...
            if not to.counted:
                ...
                # is moving up or right depending on orientation)
